function [tauf,taub] = IKJ_for_serialLeg2(Llinks,Fx,Fz,anglef,angleb)
a1 = angleb;
a2 = anglef;
x3 = -Llinks(2)*sin(a2);
z3 = -Llinks(2)*cos(a2);
...
dL6da1 = -Llinks(1)*Llinks(2)/L6*sin(a2-a1);
dL6da2 = Llinks(1)*Llinks(2)/L6*sin(a2-a1);
da1pda1 = -((L6.^2-Llinks(1).^2+Llinks(2).^2)/(2*sin(a1p)*Llinks(1)*L6.^2))*dL6da1;
da4pda1 = -((L6.^2-Llinks(4).^2+Llinks(3).^2)/(2*sin(a4p)*Llinks(4)*L6.^2))*dL6da1;
da1pda2 = -((L6.^2-Llinks(1).^2+Llinks(2).^2)/(2*sin(a1p)*Llinks(1)*L6.^2))*dL6da2;
da4pda2 = -((L6.^2-Llinks(4).^2+Llinks(3).^2)/(2*sin(a4p)*Llinks(4)*L6.^2))*dL6da2;

da4da1 = 1 + da1pda1 + da4pda1;
da4da2 = da1pda2 + da4pda2;
